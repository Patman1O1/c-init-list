...
#include "../../include/init-list/init_list.h"

namespace init_list_tests {
    // ── Method Tests (init_list_create) ──────────────────────────────────────────────────────────────────────────────
    TEST(init_list_create, empty_init_list) {
        struct ::init_list init_list = init_list_create(int, 0);
    ...
    TEST(init_list_create, single_value_init_list) {
        struct ::init_list init_list = init_list_create(int, 1, 1);
    ...
    TEST(init_list_create, multi_value_init_list) {
        struct ::init_list init_list = init_list_create(int, 5, 1, 2, 3, 4, 5);
    ...
    TEST(init_list_cmp, lhs_null) {
        const struct ::init_list rhs = init_list_create(int, 0);
    ...
    TEST(init_list_cmp, rhs_null) {
        const struct ::init_list lhs = init_list_create(int, 0);
    ...
    TEST(init_list_cmp, lhs_empty__rhs_filled) {
        const struct ::init_list lhs = init_list_create(int, 0);
        struct ::init_list rhs = init_list_create(int, 5, 1, 2, 3, 4, 5);
    ...
    TEST(init_list_cmp, lhs_filled__rhs_empty) {
        struct ::init_list lhs = init_list_create(int, 5, 1, 2, 3, 4, 5);
        const struct ::init_list rhs = init_list_create(int, 0);
    ...
    TEST(init_list_cmp, both_filled__lhs_size_larger) {
        struct ::init_list lhs = init_list_create(int, 5, 1, 2, 3, 4, 5);
        struct ::init_list rhs = init_list_create(int, 1, 6);
    ...
    TEST(init_list_cmp, both_filled__rhs_size_larger) {
        struct ::init_list lhs = init_list_create(int, 1, 1);
        struct ::init_list rhs = init_list_create(int, 5, 1, 2, 3, 4, 5);
    ...
    TEST(init_list_cmp, both_filled__both_sizes_equal__lhs_values_greater) {
        struct ::init_list lhs = init_list_create(int, 5, 6, 7, 8, 9, 10);
        struct ::init_list rhs = init_list_create(int, 5, 1, 2, 3, 4, 5);
    ...
    TEST(init_list_cmp, both_filled__both_sizes_equal__rhs_values_greater) {
        struct ::init_list lhs = init_list_create(int, 5, 1, 2, 3, 4, 5);
        struct ::init_list rhs = init_list_create(int, 5, 6, 7, 8, 9, 10);
